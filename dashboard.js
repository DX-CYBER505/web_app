...
function updateUI(data) {
    ...
    if (data.daily_watched !== undefined) {
        ...
        const progressPercentage = (data.daily_watched / data.daily_limit) * 100;
...
Telegram.WebApp.onEvent('onReceivedData', (data) => {
    // This is not a standard Telegram Web App feature, but a placeholder for a more advanced setup.
    // In our simplified model, the bot will send messages to the chat instead.
});
